...
public class BevShopNoGUITest {
	...
	public static void main(String[] args) {
		...
		System.out.println(b.getmaxAlcOrder()); // 3
		System.out.println(b.getMinageAlc()); // 21
		...
		System.out.println(b.getNumAlc()); // 2
		...
		System.out.println(b.getNumAlc()); // 3
		...
		System.out.println(b.getNumAlc()); // 0
